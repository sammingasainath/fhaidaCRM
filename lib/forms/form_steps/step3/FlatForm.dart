...
class FlatForm extends ConsumerWidget {
  final LeadFormData formData;
  final LeadFormNotifier formNotifier;

  FlatForm({required this.formData, required this.formNotifier});
  ...
  Widget _buildBasicDetails(BuildContext context, WidgetRef ref) {
    return Column(
      children: [
        _buildTextField(
            context, 'Age of Property', 'ageOfProperty', TextInputType.number),
        _buildDropdownField(
  ...
  Widget _buildSizeDetails(BuildContext context) {
    return Column(
      children: [
        ...
        _buildTextField(context, 'Total Floors in Apartment',
            'totalFloorsInApartment', TextInputType.number),
        _buildTextField(context, 'Total No. of Blocks in Apartment',
            'totalBlocksInApartment', TextInputType.number),
        _buildTextField(context, 'Total No. of Floors', 'totalFloors',
            TextInputType.number),
        _buildTextField(
            context, 'Floor of the Flat', 'floorOfFlat', TextInputType.number),
      ],
    );
  }
