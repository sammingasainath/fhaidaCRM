...
class CommercialBuildingForm extends ConsumerWidget {
  final LeadFormData formData;
  final LeadFormNotifier formNotifier;

  CommercialBuildingForm({required this.formData, required this.formNotifier});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    return CustomStepperForm(
      title: 'Commercial Building Details',
      steps: [
  ...
  Widget _buildRoomDetails(BuildContext context) {
    return Column(
      children: [
        _buildTextField(context, 'Total Number of Rooms', 'totalRooms',
            TextInputType.number),
        _buildTextField(
