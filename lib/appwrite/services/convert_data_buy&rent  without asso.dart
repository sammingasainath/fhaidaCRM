...
Future<Map<dynamic, dynamic>> convertData1withoutasso(
  ...
  var data1 = {
    ...
    'numberOfBedrooms': int.tryParse(data['numberOfBedrooms']),
    'alsoWantToSell': data['alsoWantToSell'],
    'buyerLocation': data['buyerLocation'],
    'buyerLat': double.tryParse(data['buyerLat']),
    'buyerLng': double.tryParse(data['buyerLng']),
